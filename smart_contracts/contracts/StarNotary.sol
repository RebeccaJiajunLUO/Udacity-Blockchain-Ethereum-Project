...
contract StarNotary is ERC721 {
    ...
    function tokenIDToStarInfo(uint256 _tokenId) public view returns (string name, string starStory, string ra, string dec, string mag) {
    ...
    function isStarRegistered(string _ra, string _dec, string _mag) public view returns (bool) {
